    ...
    <div v-if="shop" class="w-full max-w-4xl bg-white rounded-2xl shadow-lg p-8 grid grid-cols-1 md:grid-cols-2 gap-8">
      ...
      <div class="space-y-5">
        ...
        <div class="flex justify-center">
          <img :src="shop.logo ? `${backendBaseUrl}/storage/${shop.logo}` : `${backendBaseUrl}/images/default-carwash.png`" @error="handleImageError($event, `${backendBaseUrl}/images/default-carwash.png`)" alt="Shop Logo" class="h-24 w-24 object-contain rounded-lg border border-gray-200" />
        </div>
        <div>
        ...
        <div>
          ...
          <img :src="shop.qr_code ? `${backendBaseUrl}/storage/${shop.qr_code}` : `${backendBaseUrl}/images/default-qr.png`" @error="handleImageError($event, `${backendBaseUrl}/images/default-qr.png`)" alt="Shop QR Code" class="h-32 w-32 object-contain rounded-lg border border-gray-200" />
        </div>
      </div>
    </div>
