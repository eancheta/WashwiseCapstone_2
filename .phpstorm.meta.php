...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'auth.guards.carwashowner.driver' => 'string',
            'auth.guards.carwashowner.provider' => 'string',
            ...
            'auth.providers.carwashowners.driver' => 'string',
            'auth.providers.carwashowners.model' => 'string',
            ...
            'filesystems.links.C:\mewxamp\htdocs\Washwise\public\storage' => 'string',
...
'auth.guards.carwashowner.driver','auth.guards.carwashowner.provider','auth.guards.customer.driver','auth.guards.customer.provider','auth.providers.users.driver',
'auth.providers.users.model','auth.providers.carwashowners.driver','auth.providers.carwashowners.model','auth.passwords.users.provider','auth.passwords.users.table',
...
'filesystems.disks.s3.use_path_style_endpoint','filesystems.disks.s3.throw','filesystems.disks.s3.report','filesystems.links.C:\\mewxamp\\htdocs\\Washwise\\public\\storage','inertia.ssr.enabled',
...
'web','api',);
        registerArgumentsSet('routes', 'owner.walkin','owner.walkin.store','customer.feedback.create','customer.feedback.store',
'shops.bookings.availability','shops.bookings.store','customer.book.payment.show','customer.book.payment','customer.book.confirm',
'public.customer.book','shop.show','shop.book','public.shop.booking','public.shop.submitBooking',
'customer.book.create','customer.book.store','owner.register.show','owner.register','owner.login.show',
'owner.login','owner.verify.show','owner.verify.submit','owner.verify.resend','carwashownerdashboard',
'owner.appointments','owner.appointments.approve','owner.appointments.decline','owner.shop.create','owner.shop.store',
'owner.reviews','login','login.submit','logout','register',
'emailvcode','verify.code','loginAdmin','admindashboard',
'owners.approve','owners.decline','about','home',
'dashboard','settings','profile.edit','profile.update',
'profile.destroy','password.edit','password.update','settings.appearance',
'password.request','password.email','password.reset','password.store','storage.local',);
        registerArgumentsSet('views', 
'app','customer.feedback_form','emails.appointment_approved','emails.approved','emails.declined',
'emails.owner-verification-code','emails.verify-code','layouts.app','layouts.blade','owner.reviews',
'owner.walkin','public.shop_booking','public.shop_view','laravel-exceptions-renderer::components.card','laravel-exceptions-renderer::components.context',
...
'APP_PREVIOUS_KEYS','APP_MAINTENANCE_STORE','APP_LOCALE','APP_FALLBACK_LOCALE','APP_FAKER_LOCALE',
...
'SESSION_DOMAIN','SESSION_PATH','SESSION_SECURE_COOKIE','SESSION_ENCRYPT','BROADCAST_CONNECTION',
...
'AWS_USE_PATH_STYLE_ENDPOINT','AUTH_GUARD','AUTH_PASSWORD_BROKER','AUTH_MODEL','AUTH_PASSWORD_RESET_TOKEN_TABLE',
'AUTH_PASSWORD_TIMEOUT','VITE_APP_NAME','VITE_BACKEND_URL',);
